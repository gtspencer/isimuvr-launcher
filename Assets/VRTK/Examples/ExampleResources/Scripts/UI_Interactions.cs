namespace VRTK.Examples
{
    ...
    public class UI_Interactions : MonoBehaviour
    {
        ...
        public void gameSelected()
        {
            ...
            //gameAnimator.SetTrigger(Animator.StringToHash("SwingIn"));
            am.SetTrigger(Animator.StringToHash("SlideToGame"));
        ...
        public void backToGames()
        {
            ...
            am.SetTrigger(Animator.StringToHash("SlideToSelector"));
            //gameCanvas.SetActive(false);
            //gameAnimator.SetTrigger(Animator.StringToHash("SwingOut"));
        }
